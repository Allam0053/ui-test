...
- #### Custom Tailwind CSS Class Sorter
    ...
    Classes are sorted using [prettier-plugin-sort-class-names](https://github.com/PutziSan/prettier-plugin-sort-class-names) with custom class order on [this file](https://github.com/allam0053/nextjs-starter/blob/main/prettier-plugin-sort-class-names-order) and custom variant order on [prettierrc](https://github.com/allam0053/nextjs-starter/blob/main/.prettierrc.js)
...
- #### Husky, Prettier, Lint, and Commitlint Configured
    ...
    2. commit-msg, running commitlint to ensure the use of [Conventional Commit](https://allam-taju.vercel.app/library/conventional-commit-readme) for commit messages
...
- #### Default Tailwind CSS Base Styles
    ...
    There are default styles for responsive heading sizes, and `.layout` to support a max-width for larger screen size. Find more about it on [my blog post](https://allam-taju.vercel.app/blog/tailwindcss-best-practice#1-using-layout-class-or-container)
...
1. Seo component
2. Layout class to give constraint to viewport width. [Read more about layout class](https://allam-taju.vercel.app/blog/tailwindcss-best-practice#1-using-layout-class-or-container).
