            ...
            <ol className='mt-8 space-y-6'>
              <li className='space-y-2'>
                ...
                <div className='flex flex-wrap gap-2'>
                  ...
                  <ButtonLink href='https://github.com/allam0053/nextjs-starter/blob/main/src/styles/colors.css'>
              ...
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <UnstyledLink href='https://allam-taju.vercel.app'>
                    Outside Links
                  </UnstyledLink>
                </div>
              </li>
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <PrimaryLink href='https://allam-taju.vercel.app'>
                    Outside Links
                  </PrimaryLink>
                </div>
              </li>
              ...
              <li className='space-y-2'>
                ...
                <div className='flex flex-wrap gap-2'>
                  <ButtonLink
                    variant='primary'
                    href='https://allam-taju.vercel.app'
                  >
                    Primary Variant
                  </ButtonLink>
                  <ButtonLink
